...
<?php
    ...
    $selected_chair = array();
        ...
        if(!isset($_SESSION['temp_reserved_chair'][0]['number'])) {
            $_SESSION['temp_reserved_chair'][0]['number'] = $_GET['chair_num'];
            $_SESSION['temp_reserved_chair'][0]['row'] = $_GET['chair_row'];
            
           } else {
            $temp_total = count($_SESSION['temp_reserved_chair']);
    
            $_SESSION['temp_reserved_chair'][$temp_total]['number'] = $_GET['chair_num'];
            $_SESSION['temp_reserved_chair'][$temp_total]['row'] = $_GET['chair_row'];
